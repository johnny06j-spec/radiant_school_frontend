          ...
          <div style={{ marginBottom: '2rem' }}>
            ...
            <div style={{ position: 'relative' }}>
              <input 
                ...
                onChange={handleChange} 
                required 
                style={{ width: '100%', padding: '0.95rem 1.1rem', borderRadius: '8px', border: '1px solid #24304f', backgroundColor: '#0d162d', color: '#fff', boxSizing: 'border-box', fontSize: '14px', letterSpacing: '0.3px' }} 
              />
            </div>
          </div>
